...
/** Grille de transport (cartes de synthèse + tableau), partagée par l'onglet Employés (vue Transport). */
export function GrilleTransport({ employes, jours, taux }: { employes: Employee[]; jours: number; taux: number }) {
  ...
  return (
    <div>
      <p className="mb-4 text-sm text-muted-foreground">
        ...
        <span className="ml-2 rounded-full bg-muted px-2 py-0.5 text-xs">1&nbsp;$ = {taux.toLocaleString("fr-FR")} CDF · {jours} j ouvrables</span>
      </p>
