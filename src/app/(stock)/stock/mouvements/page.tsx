        ...
        <table className="w-full text-sm">
          <thead className="sticky top-0 bg-muted/60 text-left text-xs">
            <tr className="[&>th]:px-3 [&>th]:py-1.5">
              <th>Date</th><th>Article</th><th className="text-right">Qté</th><th className="text-right">Valeur</th>
            </tr>
          </thead>
          <tbody>
            {mouvements.map((m) => (
            ...
            {mouvements.length === 0 && <tr><td colSpan={4} className="px-3 py-6 text-center text-muted-foreground">Aucun mouvement.</td></tr>}
          </tbody>
        </table>
      </div>
    </div>
