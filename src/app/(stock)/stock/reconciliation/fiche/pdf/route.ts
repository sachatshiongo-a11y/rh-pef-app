...
export async function GET(req: Request) {
  ...
  const colonnes: Colonne[] = [
    { header: "Désignation", width: "35%" },
    { header: "Fournisseur", width: "22%" },
    { header: "Unité", width: "8%" },
    { header: "Théorique", width: "11%", align: "right" },
    { header: "Physique", width: "12%", align: "right" },
    { header: "Écart", width: "12%", align: "right" },
  ];
